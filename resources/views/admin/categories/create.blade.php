...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card-body { padding: 22px; display: flex; flex-direction: column; gap: 7px; }
        ...
        .slug-row-label { font-size: 10.5px; font-weight: 700; color: var(--violet); text-transform: uppercase; letter-spacing: .05em; flex-shrink: 0; display: flex; align-items: center; gap: 4px; }
...
<main>
    ...
    <div class="breadcrumb">
        ...
        <span class="active">Tambah Kategori</span>
    </div>

    <div class="page-hd au d1">
        <div class="ph-sub-label">Admin Panel</div>
        <h1 class="ph-title">Tambah <span>Kategori</span></h1>
        <p class="ph-desc">Buat kategori buku baru untuk perpustakaan</p>
    </div>
    ...
    <div class="card au d2">
        ...
        <div class="card-hd">
            ...
            <div>
                <div class="card-hd-title">Form Tambah Kategori</div>
                <div class="card-hd-sub">Isi nama kategori di bawah ini</div>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('admin.categories.store') }}">
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-save"><i class="fas fa-save"></i> Simpan Kategori</button>
