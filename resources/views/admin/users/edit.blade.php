...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-input:focus { border-color: var(--red); box-shadow: 0 0 0 3px rgba(220,38,38,.1); }
        .form-input.readonly { background: var(--gray-50); color: var(--gray-400); cursor: not-allowed; }
...
<main>
    ...
    <div class="breadcrumb">
        ...
        <span class="active">Edit Akun</span>
    </div>

    <div class="page-hd au d1">
        <div class="ph-sub-label">Admin Panel</div>
        <h1 class="ph-title">Edit <span>Akun</span></h1>
        <p class="ph-desc">Ubah informasi akun pengguna terdaftar</p>
    </div>
        ...
        <div class="form-layout">
            ...
            <div class="card au d2">
                <div class="card-hd">
                    ...
                    <div>
                        <div class="card-hd-title">Form Edit Akun</div>
                        <div class="card-hd-sub">ID Pengguna: <span style="font-family:'Courier New',monospace;color:var(--red-dk);font-weight:700;">#{{ $user->id }}</span></div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                            <i class="fas fa-lock input-icon" style="color:var(--gray-300);"></i>
                            <input type="text" value="{{ ucfirst($user->role) }}" class="form-input readonly" readonly>
                        </div>
                        <div class="field-hint"><i class="fas fa-info-circle" style="color:var(--gray-300);"></i> Role tidak dapat diubah melalui form ini.</div>
                    </div>
            ...
            <div class="card au d3">
                <div class="preview-banner">
                    <div class="preview-avatar" id="previewAvatar">{{ strtoupper(substr($user->name, 0, 1)) }}</div>
                ...
                <div class="preview-body">
                    ...
                    <div class="mini-info">
                        <div class="mini-ico" style="background:var(--red-bg);"><i class="fas fa-hashtag" style="color:var(--red);"></i></div>
                        <div>
                            <div class="mini-lbl">User ID</div>
                            <div class="mini-val" style="font-family:'Courier New',monospace;color:var(--red-dk);">#{{ $user->id }}</div>
                        </div>
                    </div>
                    <div class="mini-info">
                        <div class="mini-ico" style="background:var(--amber-bg);"><i class="fas fa-calendar" style="color:var(--amber);"></i></div>
                        <div>
                            <div class="mini-lbl">Dibuat</div>
                            <div class="mini-val">{{ $user->created_at->format('d M Y') }}</div>
                        </div>
                    </div>
