...
<head>
    <meta charset="UTF-8">
    <title>Edit Buku | PerpusInd</title>
...
<main>
    ...
    <div class="page-hd au d1">
        ...
        <p class="ph-desc">Perbarui informasi buku yang ada di koleksi perpustakaan</p>
    </div>
            ...
            <div class="card-hd">
                ...
                <div>
                    <div style="display:flex; align-items:center;">
                        <span class="card-hd-title">Form Edit Buku</span>
                        <span class="id-badge"><i class="fas fa-hashtag" style="font-size:9px;"></i> {{ $book->id }}</span>
                    </div>
                    <div class="card-hd-sub">Perbarui informasi buku dengan benar</div>
                </div>
            </div>

            <div class="card-body">
                <form id="editForm" method="POST" action="{{ route('petugas.books.update', $book->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    {{-- ISBN (readonly) --}}
                    <div class="field">
                        <label class="field-label"><i class="fas fa-barcode"></i> ISBN</label>
                        <div class="input-wrap">
                            <i class="fas fa-barcode input-icon"></i>
                            <input type="text" name="kode_buku" value="{{ old('kode_buku', $book->kode_buku) }}" class="form-input readonly" readonly>
                        </div>
                    ...
                    <div class="field">
                        ...
                        <div class="input-wrap">
                            ...
                            <input type="text" name="judul" value="{{ old('judul', $book->judul) }}" class="form-input" placeholder="Masukkan judul buku" required>
                        </div>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <div class="input-wrap">
                            ...
                            <input type="text" name="penulis" value="{{ old('penulis', $book->penulis) }}" class="form-input" placeholder="Masukkan nama penulis" required>
                        </div>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <div class="input-wrap">
                            ...
                            <input type="text" name="penerbit" value="{{ old('penerbit', $book->penerbit) }}" class="form-input" placeholder="Masukkan nama penerbit" required>
                        </div>
                    </div>
                    ...
                    <div class="field grid-2">
                        <div>
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="number" name="tahun" value="{{ old('tahun', $book->tahun) }}" class="form-input" min="1900" max="{{ date('Y') }}" placeholder="{{ date('Y') }}" required>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="number" name="stok" value="{{ old('stok', $book->stok) }}" class="form-input" min="0" placeholder="10" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <div class="input-wrap">
                            ...
                            <textarea name="deskripsi" class="form-textarea" placeholder="Tulis deskripsi singkat buku…">{{ old('deskripsi', $book->deskripsi) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <div class="upload-area" id="uploadArea">
                            ...
                            <div class="upload-hint">JPG, PNG · Maks 2MB · Kosongkan jika tidak ingin mengubah</div>
                        </div>
                    </div>
        ...
        <div class="preview-card au d3">
            <div class="card">
                ...
                <div class="card-body" style="padding:18px;">
                    <div class="preview-img-wrap {{ $book->image ? 'has-img' : '' }}" id="previewWrap">
                        @if($book->image)
                            <img id="previewImg" src="{{ asset('storage/' . $book->image) }}" alt="Cover">
                            <div class="preview-placeholder" id="previewPlaceholder" style="display:none;">
                                <i class="fas fa-book-open"></i><p>Belum ada cover</p>
                            </div>
                        @else
                            <img id="previewImg" src="" alt="Cover" style="display:none;">
