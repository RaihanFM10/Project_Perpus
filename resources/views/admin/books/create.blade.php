...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .file-drop-icon { width: 36px; height: 36px; border-radius: 9px; background: var(--red-bg); display: flex; align-items: center; justify-content: center; flex-shrink: 0; pointer-events: none; }
        .file-drop-icon i { color: var(--red); font-size: 14px; }
        ...
        .error-alert {
            ...
            padding: 13px 15px;
            background: var(--red-sf); border: 1px solid rgba(220,38,38,.2);
            border-radius: 10px; font-size: 13px; color: var(--red);
        }
        .error-alert i { flex-shrink: 0; margin-top: 1px; }
        .error-alert ul { list-style: disc; padding-left: 14px; display: flex; flex-direction: column; gap: 3px; }

        /* ── COVER PREVIEW CARD ── */
        .cover-banner { background: var(--red); padding: 24px 18px 40px; text-align: center; position: relative; overflow: hidden; }
        ...
        .cover-frame img { width: 100%; height: 100%; object-fit: cover; display: none; }
            ...
            <div class="card au d2">
                <div class="card-hd">
                    <div class="card-hd-icon" style="background:var(--green-bg);">
                        <i class="fas fa-book-medical" style="color:var(--green);"></i>
                    </div>
                    <div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="kode_buku">
                            ...
                            ISBN / Kode Buku <span class="req">*</span>
                        </label>
                        <div class="input-wrap">
                            <i class="fas fa-hashtag input-icon"></i>
                            <input type="text" id="kode_buku" name="kode_buku" value="{{ old('kode_buku') }}"
                                   class="form-input" required placeholder="Contoh: 978-602-123-456-7">
                        </div>
                        @error('kode_buku')<div class="field-error"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>@enderror
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="number" id="tahun" name="tahun" value="{{ old('tahun') }}"
                                       class="form-input" required min="1900" max="{{ date('Y') }}"
                                       placeholder="{{ date('Y') }}" oninput="updateMeta()">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="number" id="stok" name="stok" value="{{ old('stok') }}"
                                       class="form-input" required min="0" placeholder="0" oninput="updateMeta()">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="4" class="form-textarea"
                                  placeholder="Tulis deskripsi singkat tentang buku ini…">{{ old('deskripsi') }}</textarea>
                    ...
                    <div class="form-group">
                        <label class="form-label">
                            <span class="lbl-icon" style="background:var(--red-bg);"><i class="fas fa-image" style="color:var(--red);"></i></span>
                            Cover Buku
                        </label>
                        <div class="file-drop">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-save"><i class="fas fa-save"></i> Simpan Buku</button>
                    <a href="{{ route('admin.books.index') }}" class="btn btn-cancel"><i class="fas fa-times"></i> Batal</a>
                </div>
            </div>
                ...
                <div class="cover-body">
                    <div class="cover-info">
                        <div class="cover-info-row">
                            ...
                            <div><div class="ci-label">Judul</div><div class="ci-value" id="metaJudul" style="color:var(--gray-300);font-style:italic;">Belum diisi</div></div>
                        </div>
                        <div class="cover-info-row">
                            <div class="ci-icon" style="background:var(--amber-bg);"><i class="fas fa-pen" style="color:var(--amber);"></i></div>
                            <div><div class="ci-label">Penulis</div><div class="ci-value" id="metaPenulis" style="color:var(--gray-300);font-style:italic;">Belum diisi</div></div>
                        </div>
                        <div class="cover-info-row">
                            <div class="ci-icon" style="background:var(--green-bg);"><i class="fas fa-layer-group" style="color:var(--green);"></i></div>
                            <div><div class="ci-label">Stok</div><div class="ci-value" id="metaStok" style="color:var(--gray-300);font-style:italic;">—</div></div>
                        </div>
                        <div class="cover-info-row">
                            <div class="ci-icon" style="background:var(--amber-bg);"><i class="fas fa-calendar" style="color:var(--amber);"></i></div>
                            <div><div class="ci-label">Tahun</div><div class="ci-value" id="metaTahun" style="color:var(--gray-300);font-style:italic;">—</div></div>
                        </div>
                    </div>
